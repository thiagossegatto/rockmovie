...
const Star = ({ onClick, style }: IProps) => (
  <button onClick={onClick}>
    <svg version="1.1" id="Capa_1"
      viewBox="0 0 512.001 512.001" width="25" height="25">
      <path style={style} d="M499.92,188.26l-165.839-15.381L268.205,19.91c-4.612-10.711-19.799-10.711-24.411,0l-65.875,152.97
	...
	C516.225,203.78,511.532,189.337,499.92,188.26z"/>
      <path style={style} d="M268.205,19.91c-4.612-10.711-19.799-10.711-24.411,0l-65.875,152.97L12.08,188.26
